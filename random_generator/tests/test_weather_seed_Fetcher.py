...
def test_fetch_data(mock_get, mock_response):
    ...
    data = WeatherSeedFetcher._WeatherSeedFetcher__fetch_data()
...
def test_encode_data():
    ...
    seed = WeatherSeedFetcher._WeatherSeedFetcher__encode_data(weather_data)
    assert seed == 2015648683

@patch('random_generator.web.api.random.seed_fetchers.WeatherSeedFetcher._WeatherSeedFetcher__fetch_data')
@patch('random_generator.web.api.random.seed_fetchers.WeatherSeedFetcher._WeatherSeedFetcher__encode_data')
